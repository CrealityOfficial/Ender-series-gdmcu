...
// #define ENDER3_MAX
// #define ENDER5_PRO
// #define ENDER2_PRO165
// #define ENDER2_PRO200
...
// Author info of this build printed to the host during boot and M115
  ...
  #define STRING_CONFIG_H_AUTHOR "Ender-3 MAX" // Who made the changes.
#elif ENABLED(ENDER5_PRO)
  #define STRING_CONFIG_H_AUTHOR "Ender-5 Pro" // Who made the changes.
#elif ENABLED(ENDER2_PRO165)
  #define STRING_CONFIG_H_AUTHOR "Ender_2 Pro" // Who made the changes.
#elif ENABLED(ENDER2_PRO200)
  #define STRING_CONFIG_H_AUTHOR "Ender-2 Pro" // Who made the changes.
#else
  #define STRING_CONFIG_H_AUTHOR "Ender-Series" // Who made the changes.
#endif
...
// Name displayed in the LCD "Ready" message and Info menu
  ...
  #define CUSTOM_MACHINE_NAME "Ender-2 Pro"
#else
  #define CUSTOM_MACHINE_NAME "Ender-Series"
#endif
 ...
 */
/*此部分只定义一种语言，其它语言定义在Configuration_adv.h中进行配置*/
