...
*                 -----
*                 EXP1
* Note: The pin-numbers match the connector correctly and are not in reverse order like on the Ender-5 Pro board.
* Note: Functionally the pins are assigned in the same order as on the Ender-5 Pro board.
* Note: Pin 4 on the Cheetah board is assigned to an I/O, it is assigned to RESET on the Ender-5 Pro board.
*/
